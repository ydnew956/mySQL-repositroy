...
-- Create table structure for table 'city'
CREATE TABLE city (
...
-- Create Index (PostgreSQL requires separate statements for secondary indexes)
CREATE INDEX idx_city_countrycode ON city (countrycode);

-- Note: This foreign key assumes a 'country' table with a 'code' column already exists.
-- If it doesn't exist yet, you can run this ALTER statement after creating the country table.
...
INSERT INTO city VALUES (340,'Dourados','BRA','Mato Grosso Sul',164716);
...
INSERT INTO city VALUES (426,'São Józé de Ribamar','BRA','Maranhão',98318);
...
INSERT INTO city VALUES (516,'Yorkdallasallas','GBR','England',104425);
...
-- Synchronize the auto-increment sequence with manually inserted IDs
SELECT setval(pg_get_serial_sequence('city', 'id'), coalesce(max(id), 1)) FROM city;

DROP TYPE IF EXISTS continent_enum CASCADE;
...
-- 3. Insert Data (Wrapped in a transaction block to mimic set autocommit=0)
BEGIN;
...
-- Note: Fixed an escaped single quote in China's People's Republic field for PostgreSQL standard
...
-- 1. Create custom ENUM type for IsOfficial
CREATE TYPE isofficial_enum AS ENUM ('T', 'F');

-- 2. Create the countrylanguage table
CREATE TABLE countrylanguage (
    CountryCode char(3) NOT NULL DEFAULT '',
    Language char(30) NOT NULL DEFAULT '',
    IsOfficial isofficial_enum NOT NULL DEFAULT 'F',
    Percentage decimal(4,1) NOT NULL DEFAULT 0.0,
    PRIMARY KEY (CountryCode, Language),
    CONSTRAINT countryLanguage_ibfk_1 FOREIGN KEY (CountryCode) REFERENCES country (Code)
);

-- 3. Create the Index separately (Postgres handles secondary keys this way)
CREATE INDEX idx_countrylanguage_countrycode ON countrylanguage (CountryCode);

-- 4. Insert Data inside a safe transaction block
BEGIN;
...
-- Note: Fixed MySQL escaping on '[South]Mande' column data below
...
ALTER TABLE city ADD COLUMN country_code CHAR(3);
